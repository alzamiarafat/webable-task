    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <form action="{{route('data.store')}}" method="POST" enctype="multipart/form-data" style="border: 5px solid #2d3748; padding: 3%">
                    @csrf
...
<body>
    ...
    <div class="container">
        <h4 class="text-center mt-4">Comments Upload</h3>
            <form action="{{ route('data.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row my-3">
                    <div class="col-6">
                        <input type="file" id="data" class="form-control" name="json_data">
                    </div>
                    <div class="col-4">
...
<script>
    ...
    // $("#dataStore").submit(function(event) {
